...
void controllerBrescianini(control_t *control,
  ...
  // Check for direct force/torque passthrough mode
  if (setpoint->mode.x == modeDisable && 
    ...
    // Direct force/torque passthrough
    control->controlMode = controlModeForceTorque;
    control->thrustSi = setpoint->thrust;
    control->torqueX = setpoint->attitudeRate.roll;
    control->torqueY = setpoint->attitudeRate.pitch;
    control->torqueZ = setpoint->attitudeRate.yaw;
